...
def _(
    ...
    deriv_listner.start()
    return deriv_listner, synth_worker


@app.cell
def _(deriv_listner, mo, synth_worker):
    def stop_workers():
        synth_worker.stop_worker()
        deriv_listner.stop()


    button = mo.ui.button(label="Stop Streaming", on_click=stop_workers)
    button
    return
...
@app.cell
def _(deriv_listner):
    deriv_listner.payouts[deriv_listner.display_col_seq]
    return
